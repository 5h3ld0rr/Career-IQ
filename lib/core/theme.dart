...
class AppTheme {
  ...
  static const Color darkText = Color(0xFF1A1C1E); // Deep text color for light mode
  ...
  static ThemeData darkTheme = ThemeData(
    ...
    textTheme: GoogleFonts.outfitTextTheme().copyWith(
      ...
      displayMedium: GoogleFonts.outfit(fontSize: 24, fontWeight: FontWeight.w700, color: Colors.white),
      titleLarge: GoogleFonts.outfit(fontSize: 20, fontWeight: FontWeight.w700, color: Colors.white),
    ),
    appBarTheme: AppBarTheme(
      backgroundColor: Colors.transparent,
      elevation: 0,
