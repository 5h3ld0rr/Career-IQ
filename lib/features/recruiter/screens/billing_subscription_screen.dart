...
import 'package:careeriq/features/recruiter/screens/payment_checkout_screen.dart';
          ...
          return pw.Padding(
            ...
            child: pw.Column(
              ...
              children: [
                ...
                pw.SizedBox(height: 10),
                pw.Text(
                  'Thank you for choosing CareerIQ!',
                  style: pw.TextStyle(fontSize: 12, color: PdfColors.grey600),
                ),
                pw.Text(
                  'For support, contact billing@careeriq.com',
      ...
      children: [
        Expanded(
          child: _buildPlanCard(
            ...
            '\$0',
            _isYearly ? '/yr' : '/mo',
            ['Unlimited Jobs', '50 AI Matches/mo', 'Standard Support'],
            theme,
            isDark,
          ),
        ),
        ...
        Expanded(
          child: _buildPlanCard(
            ...
            _isYearly ? '\$100' : '\$10',
            _isYearly ? '/yr' : '/mo',
            ['Unlimited Jobs', 'Unlimited AI Matches', 'Priority Support'],
            theme,
            isDark,
          ),
        ),
                ...
                onPressed: isCurrentPlan
                    ...
                    : () async {
                        ...
                        if (paymentSuccess == true) {
                          ...
                          AppSnackBar.show(
                            'Successfully upgraded to $title plan! 🚀',
                          );
                        }
                      },
