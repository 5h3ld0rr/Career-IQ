  ...
  final List<Map<String, dynamic>> _messages = [
    {
      'isUser': false,
      'text':
          'Hello! I am your Career IQ Expert. Ask me anything about job hunting, resume optimization, or interview strategies.',
    },
  ];
  ...
  final List<Map<String, String>> _chatHistory = [
    {
      'role': 'system',
      'content':
          'You are Career IQ Expert, a professional career coach. Help users with career advice, resumes, and interviews. Be concise, professional, and encouraging.',
    },
    {
      'role': 'assistant',
      'content':
    ...
    try {
      ...
      setState(() {
        _messages.add({
          'isUser': false,
          'text':
              "Error: Could not reach the AI Expert. Please check your connection.",
        });
        _isLoading = false;
      });
    }
