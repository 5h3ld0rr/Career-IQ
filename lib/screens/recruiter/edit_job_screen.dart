...
class _EditJobScreenState extends State<EditJobScreen> {
  ...
  void initState() {
    ...
    _phoneController = TextEditingController(text: widget.job.companyPhone ?? '');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Edit Job', style: TextStyle(fontWeight: FontWeight.w900)),
    ...
    return SizedBox(
      ...
      child: ElevatedButton(
        ...
        onPressed: jobProvider.isLoading
            ...
            : () async {
                if (_formKey.currentState!.validate()) {
                  ...
                  try {
                    await jobProvider.addJob(updatedJob); // Using addJob as it sets by ID (upsert)
                    if (mounted) {
        ...
        child: jobProvider.isLoading
            ...
            : const Text('Update Job', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16)),
      ),
    );
  }
}
