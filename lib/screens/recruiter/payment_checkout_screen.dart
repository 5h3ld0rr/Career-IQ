...
class _PaymentCheckoutScreenState extends State<PaymentCheckoutScreen> {
        ...
        builder: (context) => AlertDialog(
          ...
          title: Column(
            children: [
              ...
              const Text('Payment Successful!', style: TextStyle(fontWeight: FontWeight.w900)),
            ],
          ),
          content: Text(
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                onPressed: () {
                  ...
                  Navigator.of(context).pop(true); // screen, return true to indicate success
                },
  ...
  Widget _buildPaymentMethods(ThemeData theme) {
    return Row(
      children: [
        Expanded(child: _buildCardChoice('Visa', Icons.credit_card_rounded, theme)),
        const SizedBox(width: 16),
        Expanded(child: _buildCardChoice('Mastercard', Icons.credit_score_rounded, theme)),
      ],
    );
  }
  ...
  Widget _buildCardChoice(String title, IconData icon, ThemeData theme) {
    ...
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          color: isSelected ? theme.colorScheme.primary.withValues(alpha: 0.1) : AppTheme.getGlassColor(context).withValues(alpha: 0.3),
          borderRadius: BorderRadius.circular(16),
          border: Border.all(
            color: isSelected ? theme.colorScheme.primary : AppTheme.getGlassBorderColor(context),
        ...
        child: Row(
          ...
          children: [
            Icon(icon, color: isSelected ? theme.colorScheme.primary : theme.colorScheme.onSurface.withValues(alpha: 0.5), size: 24),
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: [
              const Text('Total Due Today', style: TextStyle(fontWeight: FontWeight.w700, fontSize: 14)),
              Text(
                widget.planPrice,
